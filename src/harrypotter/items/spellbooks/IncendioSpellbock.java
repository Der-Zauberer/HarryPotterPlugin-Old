...
public class IncendioSpellbock implements UsableItem {

	@Override
	public ItemStack getItem() {
		ItemBuilder itembuilder = new ItemBuilder("Incendio Spellbock", Material.BOOK);
		itembuilder.setCustomModelData(3);
	...
	public void onItemUse(Player player, ItemStack itemstack, Action action) {
		if(action == Action.RIGHT_CLICK_AIR || action == Action.RIGHT_CLICK_BLOCK) {
			SpellHandler.addPlayerSpell(player, Spell.INCENDIO);
		}
	}
