...
public class AguamentiSpellbock implements UsableItem {

	@Override
	public ItemStack getItem() {
		ItemBuilder itembuilder = new ItemBuilder("Aguamenti Spellbock", Material.BOOK);
	...
	public void onItemUse(Player player, ItemStack itemstack, Action action) {
		if(action == Action.RIGHT_CLICK_AIR || action == Action.RIGHT_CLICK_BLOCK) {
			SpellHandler.addPlayerSpell(player, Spell.AGUAMENTI);
		}
	}
