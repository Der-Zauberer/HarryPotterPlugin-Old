...
public class StuporSpellbock implements UsableItem {

	@Override
	public ItemStack getItem() {
		ItemBuilder itembuilder = new ItemBuilder("Stupor Spellbock", Material.BOOK);
		itembuilder.setCustomModelData(6);
	...
	public void onItemUse(Player player, ItemStack itemstack, Action action) {
		if(action == Action.RIGHT_CLICK_AIR || action == Action.RIGHT_CLICK_BLOCK) {
			SpellHandler.addPlayerSpell(player, Spell.STUPOR);
